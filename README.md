...
## ✅ 페이지 이동 경로<br />
오시는 길 페이지 : header에 보이는 navigation에 영어마을소개 -> 오시는 길 클릭 / 메인페이지 가운데에 4가지 목록이 있는 부분에서 가장 오른쪽 오시는 길 클릭<br />
학습 테스트 페이지 : header에 보이는 navigation에 프로그램 신청 -> 학습 테스트 클릭 / 메인페이지 가운데에 4가지 목록이 있는 부분에서 3번 째의 학습 테스트 클릭<br />
프로그램 신청 페이지 : header에 보이는 navigation에 프로그램 신청 -> 프로그램 신청 클릭 / 메인페이지 가운데에 4가지 목록이 있는 부분에서 2번 째의 프로그램 신청 클릭<br />
예약 페이지 : 프로그램 신청 페이지에 들어간 뒤 2번 째의 4박 5일 프로그램에 있는 예약하기 버튼 클릭<br />
마을 소개 페이지 : header에 보이는 navigation에 영어마을소개 -> 마을 소개 클릭 / 메인페이지 오른쪽에 보이는 캐릭터 클릭 후 첫 번째로 있는 마을 소개 클릭<br />
<br />
